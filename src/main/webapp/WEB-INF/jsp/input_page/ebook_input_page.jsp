    ...
    <main class="wrapper">
        <section class="section_data">
            <form class="form_input" action="controller" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="rom" pattern="^[0-9]+$" required title="Введите число"
                       maxlength="2"
                       value="${product.ROM}"/>
                <label>
                    <fmt:message bundle="${loc}" key="product.characteristic.RAM"/>
                </label>
                <input type="text" name="ram" pattern="^[0-9]+$" required  title="Введите число"
                       maxlength="2"
                       value="${product.RAM}"/>
                <label>
                ...
                <input type="text"
                       pattern="[A-Za-zА-Яа-я\sЁё0-9]{2,}" required
                ...
                <input type="text"
                       pattern="[A-Za-zА-Я\sа-яЁё\s]{2,}" required
                       name="type_screen"
                       maxlength="50"
                ...
                <input type="text" name="battery_capacity" pattern="^[0-9]+$" required  title="Введите число"
                       maxlength="5"
                       value="${product.batteryCapacity}"/>
                <label>
                    <fmt:message bundle="${loc}" key="product.characteristic.diagonal"/>
                </label>
                <input type="text" name="diagonal" pattern="\d+(.\d{1})?" required  title="Введите число"
                       maxlength="6"
                ...
                <input type="text" name="formats"
                       pattern="[A-Za-zА-Яа-яЁё0-9,\s]{2,}" required
                       maxlength="50"
